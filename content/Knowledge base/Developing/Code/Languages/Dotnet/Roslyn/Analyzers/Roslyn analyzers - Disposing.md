Существует несколько стандартных [[../Roslyn analyzers|Roslyn анализаторов]], которые находят проблемы с использованием [[../../CSharp/Instance disposing|IDisposable]]:
- CA2000
- CA2213
...
При выставлении `at_constructor` [[../Roslyn Data flow analys|Roslyn Data flow analys]] будет считать, что для всех передаваемых IDisposable экземпляров также передаётся и ownership .
```csharp
public void Method()
{
  // Default: Warning
