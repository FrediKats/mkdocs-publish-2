Roslyn-анализаторы - это [[../../../../../Project management/Static code analyze|статические анализаторы кода]], который встраиваются в [[./Roslyn|Roslyn]] и выполняются во время сборки проекта или солюшена.
