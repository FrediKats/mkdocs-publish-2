ResolvePackageAssets - это [[./MSBuild task|MSBuild task]], которая формирует список зависимостей проекта от [[../Nuget/Nuget|Nuget]] файлов.
...
- [[../Roslyn/Roslyn analyzers|Roslyn analyzers]], например:
