...
## Solution restore
Основным [[./MSBuild target|таргетом]] команды рестора является RestoreTask. Задача RestoreTask - сформировать список используемых [[../Nuget/Nuget|Nuget]] пакетов в проектах и загрузить их. Есть два основных артефакта работы этой таски:
- [[./MSBuild artifact directories#project.assets.json|MSBuild artifact directories > project.assets.json]]] файлы для каждого проекта
