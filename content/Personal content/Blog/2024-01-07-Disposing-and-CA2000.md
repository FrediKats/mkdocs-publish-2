...
Существует несколько стандартных [[../../Knowledge base/Developing/Code/Languages/Dotnet/Roslyn/Roslyn analyzers|Roslyn анализаторов]], которые находят проблемы с использованием [[../../Knowledge base/Developing/Code/Languages/Dotnet/CSharp/Instance disposing|IDisposable]]:
- CA2000
- CA2213
...
При выставлении `at_constructor` [[../../Knowledge base/Developing/Code/Languages/Dotnet/Roslyn/Roslyn Data flow analys|Roslyn Data flow analys]] будет считать, что для всех передаваемых IDisposable экземпляров также передаётся и ownership .
```csharp
public void Method()
{
  // Default: Warning
